...
using DAL;
using PVT.WebApp.ViewModels;
using AutoMapper;
using Microsoft.Extensions.Logging;
using PVT.WebApp.Helpers;

namespace PVT.WebApp.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        public async Task<string> Email()
        {
            ...
            (bool success, string errorMsg) = await _emailSender.SendEmailAsync(recepientName, recepientEmail, "Test Email from PVT.WebApp", message);
